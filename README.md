...
- wget -4 -O /koolshare/scripts/ks_tar_install.sh https://github.com/Auroraxpm/fancyss/blob/master/ks_tar_install.sh && chmod 777 /koolshare/scripts/ks_tar_install.sh
